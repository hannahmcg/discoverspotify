...
const Login = ( {providers}: Props ) => {
  return (
    <div className="flex flex-col items-center bg-black min-h-screen w-full justify-center">
      ...
      <h3 className="text-l text-gray-400">This app is like spotify wrapped but a little different. Take a look if you're curious to see more about your listening habits and discover new sounds!</h3>
