  ...
  return (
    <div className="flex flex-col bg-black min-h-screen w-full justify-center items-center">
      <div className="text-center">
        <h1 className="text-6xl text-white py-10 tracking-wider">DISCOVERSPOTIFY</h1>
      ...
      <footer className="fixed bottom-0">
        <h3 className="text-md text-gray-500 pb-10 px-10">Don't worry! Your Spotify account is always protected by Spotify's authorization scopes which will be displayed to you before logging in.</h3>
      </footer>
    </div>
  )
};
