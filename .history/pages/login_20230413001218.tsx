...
const Login = ( {providers}: Props ) => {
  return (
    <div className="flex flex-col bg-black min-h-screen w-full justify-center items-center">
      ...
      <footer>
        <h3 className="text-md text-gray-500 pt-50 px-10">This app connects directly to your spotify account and is protected by spotify's API authorization scopes which will be displayed to you before logging in.</h3>
      </footer>
    </div>
  )
};
