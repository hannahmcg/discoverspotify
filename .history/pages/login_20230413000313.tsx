...
const Login = ( {providers}: Props ) => {
  return (
    <div className="flex flex-col items-center bg-black min-h-screen w-full justify-center">
      ...
      <footer>
      <h3 className="text-md text-gray-500 pt-20 px-20">This app connects directly to your spotify account and is protected by spotify's API authorization scopes which will be displayed to you before logging in.</h3>
      </footer>
    </div>
  )
};
