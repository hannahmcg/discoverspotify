  ...
  return (
    <div className="flex flex-col bg-black min-h-screen w-full justify-center items-center">
      ...
      <footer className="fixed bottom-0">
        <h3 className="text-md text-gray-500 pb-15 px-10">This app connects directly to your spotify account and is protected by spotify's API authorization scopes which will be displayed to you before logging in.</h3>
      </footer>
    </div>
  )
};
