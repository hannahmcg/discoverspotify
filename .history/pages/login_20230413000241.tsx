...
const Login = ( {providers}: Props ) => {
  return (
    <div className="flex flex-col items-center bg-black min-h-screen w-full justify-center">
      ...
      <footer>
      <h3 className="text-l text-gray-500 pt-300 mb-0">This app connects directly to your spotify account and is protected by spotify's API authorization scopes which will be displayed to you before logging in.</h3>
      </footer>
    </div>
  )
};
