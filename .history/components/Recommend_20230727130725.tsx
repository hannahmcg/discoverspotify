  ...
  return (
    <div className="items-center space-y-5 p-5">
      ...
      <div className="flex space-x-10">
        <div>
          <button onClick={generatePlaylist} className="text-xl text-blue-500 py-2 px-4 bg-slate-700 rounded-full">Generate Playlist</button>
          <div className="flex flex-col space-y-2 bg-slate-800 mt-5 p-2">
            {playlist1?.map((track) => (
        ...
        <div>
          <button onClick={generatePlaylist2} className="text-xl text-blue-500 py-2 px-4 bg-slate-700 rounded-full">Generate Playlist2</button>
