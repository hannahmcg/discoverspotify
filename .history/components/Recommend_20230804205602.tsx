    ...
    <div className="items-center space-y-5 p-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div>
          ...
          <div className="flex flex-col space-y-2 bg-slate-800 mx-4 mt-5 p-3 rounded-lg h-[500px] overflow-y-scroll">
            {playlist1?.map((track) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <h3 className="pb-2">Based off your top tracks</h3>
          ...
          <div className="flex flex-col space-y-2 bg-slate-800 mx-4 mt-5 p-3 rounded-lg h-[500px] w-[600px] overflow-y-scroll">
            {playlist3?.map((track) => (
              <div key={track.id} className="flex space-x-5 items-center ">
                <Image src={track.album?.images?.[0]?.url} alt="" width={40} height={40}/>
                <p>{track.artists?.[0]?.name}:</p>
