  ...
  return (
    <div className="m-10">
      <div>
        ...
        <div className="flex flex-grow items-center space-x-20 p-4 justify-center">
          {topArtists.map((artist) => (
            <div key={artist.id} className="flex flex-col items-center overflow-x-scroll"> {/* overflow-scroll w-screen --add if increase artists to 10*/}
      ...
      <div className="">
        ...
        <div className="flex items-center justify-center space-x-10 p-4 overflow-x-scroll w-[500px]">
          {topTracks.map((track) => (
